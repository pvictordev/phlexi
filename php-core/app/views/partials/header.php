<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
        <a class="navbar-brand logo" href="/">
            <img alt="Phlexi Logo" class="img-fluid" height="" src="../resources/assets/favicon.svg">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent9">
            ...
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-start dropdown-toggle btn" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
