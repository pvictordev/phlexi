            ...
            <div class="row gx-5 align-items-center">
              <div class="col-md-4 mb-5 mb-md-0">
                <img
                  ...
                  src="https://static.vecteezy.com/system/resources/previews/000/683/375/original/office-work-concept-illustration-with-happy-male-office-worker-sitting-at-the-table-with-full-battery.jpg"
                />
              </div>
              <div class="col-md-8">
                <div class="row gy-4">
              ...
              <div class="col-md-6 mx-auto">
                <div class="row">
                  <div class="col-auto text-center">
                    <div
                      class="d-flex rounded-circle align-items-center justify-content-center bg-primary text-white fs-3 fw-bold border border-white border-4 me-1"
          ...
          <div class="">
            ...
            >
              ...
              <button
                ...
                data-bs-slide="prev"
                data-bs-target="#galleryCarouse1"
                type="button"
              >
                <span
                  aria-hidden="true"
          ...
          <div class="">
            ...
            <div class="row py-5">
              <div class="col-md-4 py-2 py-md-2">
                <div
                  class="card-testimonials mb-5 mb-md-0 p-2 p-lg-5 text-center position-relative"
                >
                  <img
                    alt=""
                    class="rounded-circle position-absolute translate-middle top-0"
                    height="96"
                    src="assets/default-img.png"
                    width="96"
                  />
